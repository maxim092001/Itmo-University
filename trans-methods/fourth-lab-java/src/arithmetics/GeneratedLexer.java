...
Map.entry(GeneratedEnum.EToken.NOT, Pattern.compile("~")),
Map.entry(GeneratedEnum.EToken.AND, Pattern.compile("&")),
Map.entry(GeneratedEnum.EToken.OR, Pattern.compile("\\|")),
Map.entry(GeneratedEnum.EToken.XOR, Pattern.compile("\\^"))
);
